...
ggsave(filename = here("Manuscripts", "Gender Comprehension Manuscript (Frontiers)", "Graphs", "Frontiers Gender Figure 3.pdf"),
...
ggsave(filename = here("Manuscripts", "Gender Comprehension Manuscript (Frontiers)", "Graphs", "Frontiers Gender Figure 4.pdf"),
       plot = Feminine_Graph,
       device = "pdf",
       width = 6.5,
       height = 3.5,
